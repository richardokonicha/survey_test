                        ...
                        data.map((item: ItemProps, index: number) => (
                            <tr className="bg-white border-b hover:bg-slate-50 " key={item.id}>
                                ...
                                <td className="py-3 px-8  whitespace-normal sm:max-w-lg text-primary ">
                                    ...
                                    <span className="sm:hidden inline-block bg-blue-100 text-blue-800 text-xs font-thin mr-2 px-1 py-0.2 rounded">{item.browser.platform}</span>
                                    <span className=" sm:hidden inline-block  bg-gray-100 text-gray-800 text-xs font-thin mr-2 px-1 py-0.2 rounded"> {item.computed_browser.Platform}</span>
                                </td>
